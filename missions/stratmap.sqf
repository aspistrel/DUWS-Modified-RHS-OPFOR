...
if (_found_dist_away) then {};
    ...
    switch (_counter) do
   {
    case 0: // mission RECOVER
    {
        ...
        MissionNameCase0,
        "Destroy the grounded Chopper<br/>A Russian Helicopter has landed in the area, possibly to scout the area with an SF team, remove it from the AO",
        "",
	...
	case 1: // mission ROULETTE
    {
        ...
        MissionNameCase1,
        "DEFUSE THE BTR<br/>Get a BTR-80A and 200 spendable CP or risk losing it all!<br/><br/>You must locate the defuse code on one of the enemy patrol units in the AO, then locate and safely defuse the BTR which is set to explode in 30 minutes. If you succeed your reward will earn you an extra 200 spendable Command Points and you get to keep the BTR, but if you fail all of your current Command Points will be taken away!<br/><br/>...well, you'll get to keep 2cp for a ride home and a Sitrep.",
        "",
        "\a3\ui_f\data\gui\cfg\hints\IEDs_ca.paa",
        1,
        []
    ...
    case 4: // mission STEAL
    {
        ...
        MissionNameCase4,
        "A Russian truck full of supplies is stuck somewhere here. Find it and bring it back to base safely.",
        "",
    ...
    case 5: // mission TARGET
    {
        ...
        MissionNameCase5,
        "Our scouts have reported a person of interest around this area, possibly a VDV officer. Find him and deal with him. It is likley that the Russians will send in further reinforcements if you are successful.",
        "",
    ...
    case 6: // mission DESTROY
    {
        ...
        MissionNameCase6,
        "A Russian Communications outpost has been set up in this area. You must destroy it.",
        "",
        "\a3\ui_f\data\gui\cfg\hints\IEDs_ca.paa",
        1,
        []
    ...
    case 8: // mission SABOTAGE
    {
        ...
        MissionNameCase8,
        "The Russians are using a power transformer near this location. We need to sabotage this power supply in order to disrupt their electronic communications.",
        "",
    ...
    case 9: // mission RADAR
    {
        ...
        _missionArray = [[(_foundSafepos select 0)+(random _radius)-(random _radius),(_foundSafepos select 1)+(random _radius)-(random _radius)],
        {_handle = [PosOfCase8Mission] execVM "missions\missions\radar\mission.sqf"; _handle = execVM "missions\missionTimer.sqf"},
        MissionNameCase9,
        "The Russians have set up a significant forward Anti-Air position to interfere US and NATO air patterns in the AO. The position is reported to be defended by at least one ZSU-23-4 Shilka and multiple specialist MANPADS teams, it goes without saying that it is imperative that the Radar is found and destroyed ASAP, otherwise it will prove a major hindrance to aerial operations in the forseeable future",
        "",
        "\a3\ui_f\data\gui\cfg\hints\Rules_ca.paa",
        1,
        []
    ...
    case 10: // mission Hunt
    {
        ...
        _missionArray = [[(_foundSafepos select 0)+(random _radius)-(random _radius),(_foundSafepos select 1)+(random _radius)-(random _radius)],
        {_handle = [PosOfCase8Mission] execVM "missions\missions\sniper\mission.sqf"; _handle = execVM "missions\missionTimer.sqf"},
        MissionNameCase9,
        "Our Squads are being harassed by Snipers in this area, find the Sniper team and eliminate them",
        "",
        "\a3\ui_f\data\gui\cfg\hints\Annoucning_ca.paa",
        1,
        []
    ...
    case 11: // mission ARMOUR
    {
        ...
        _missionArray = [[(_foundSafepos select 0)+(random _radius)-(random _radius),(_foundSafepos select 1)+(random _radius)-(random _radius)],
        {_handle = [PosOfCase8Mission] execVM "missions\missions\sdv\mission.sqf"; _handle = execVM "missions\missionTimer.sqf"},
        MissionNameCase9,
        "A Russian SDV is being prepared inland for use on the coast, Instead of destroying it Command wants you to airlift it back to HQ for analysis, after that you can probably keep it for your own use in future operations.",
        "",
        "\a3\ui_f\data\gui\cfg\hints\BasicSpeed_ca.paa",
        1,
        []

...
_group = [_position, WEST, ["rhsusf_army_ocp_teamleader","rhsusf_army_ocp_machinegunner","rhsusf_army_ocp_javelin","rhsusf_army_ocp_grenadier"],[],[],opfor_ai_skill] call BIS_fnc_spawnGroup;

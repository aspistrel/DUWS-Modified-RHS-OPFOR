...
{  
	class island_captured_win
	{
		...
		subtitle = "";
		description = "You have successfully captured all the zones and destroyed the Russian forces on the island. This island is now under NATO control. Time to take back another island, soldier...";
		pictureBackground = "";

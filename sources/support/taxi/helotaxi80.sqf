...
if (commandpointsblu1 < 14) exitWith {
...
_helo = createVehicle ["RHS_CH_47F", [_posplayer select 0, (_posplayer select 1)+2000, 200],[], 0, "FLY"];
_helogroup = createGroup west; 
_pilot = _helogroup createUnit ["rhsusf_army_ocp_helipilot", [5,5,5], [], 0, "NONE"];
_copilot = _helogroup createUnit ["rhsusf_army_ocp_helipilot", [5,5,5], [], 0, "NONE"];

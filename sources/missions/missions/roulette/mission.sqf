...
_taskhandle setSimpleTaskDescription ["DEFUSE THE BTR<br/>Get a BTR-80A and 200 spendable CP or risk losing it all!<br/><br/>You must locate the defuse code on one of the enemy patrol units in the AO, then locate and safely defuse the BTR-80A which is set to explode in 30 minutes. If you succeed your reward will earn you an extra 200 spendable Command Points and you get to keep the BTR, but if you fail all of your current Command Points will be taken away!<br/><br/>...well, you'll get to keep 2cp for a ride home and a Sitrep",_mission_name,""];
...
_gorgon1 = "rhs_btr80a_vdv" createVehicle (_missionpos);
_gorgon1 lock true;
_Varname = "GORGON1";
...
sleep 1;
_bombcode1 = [_randompos, EAST, ["rhs_vdv_rifleman", "rhs_vdv_rifleman"],[],[],opfor_ai_skill] call BIS_fnc_spawnGroup;

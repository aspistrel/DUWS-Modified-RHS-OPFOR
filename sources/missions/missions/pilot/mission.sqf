...
_pilot = _group createUnit ["rhsusf_army_ocp_helipilot", [_missionpos select 0, (_missionpos select 1)+2], [], 0, "FORM"];
_pilot setcaptive true; 
_pilot switchMove "acts_CrouchingIdleRifle01";

// TASK AND NOTIFICATION
_taskhandle = player createSimpleTask ["taskPilot"];
_taskhandle setSimpleTaskDescription ["One of our C-130's has been downed somewhere around this area. We have reports that one of the crew is still alive. You must find him and bring him back to base.",_mission_name,""];

...
_target = _group createUnit ["rhs_vdv_officer_armored", _missionpos, [], 0, "FORM"]; 
_unit = _group createUnit ["rhs_vdv_rifleman", _missionpos, [], 0, "FORM"];
_unit = _group createUnit ["rhs_vdv_rifleman", _missionpos, [], 0, "FORM"];

// TASK AND NOTIFICATION
_taskhandle = player createSimpleTask ["taskTarget"];
_taskhandle setSimpleTaskDescription ["An elite VDV Officer has been spotted somewhere in this location by our scouts. It would be benificial to remove him. It is likley that the Russians will send more troops into the AO in retaliation if you succeed.",_mission_name,""];

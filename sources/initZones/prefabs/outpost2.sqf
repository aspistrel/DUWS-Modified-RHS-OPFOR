...
if (true) then
{
  _this = createVehicle ["rhs_weapons_crate_ak_standard", [1815.2917, 5617.042, 8.5830688e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_23 = _this;
...
if (true) then
{
  _this = createVehicle ["rhs_weapons_crate_ak_standard", [1815.8658, 5616.4819, -4.2915344e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_24 = _this;
...
if (true) then
{
  _this = createVehicle ["rhs_Flag_Russia_F", [1819.0468, 5623.0957], [], 0, "CAN_COLLIDE"];
  _vehicle_78 = _this;

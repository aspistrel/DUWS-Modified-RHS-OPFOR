...
if (true) then
{
  _this = createVehicle ["rhs_weapons_crate_ak_standard", [1815.88, 5623.1592, -2.3841858e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_28 = _this;
...
if (true) then
{
  _this = createVehicle ["rhs_Flag_Russia_F", [1814.5321, 5623.4312, -9.5367432e-007], [], 0, "CAN_COLLIDE"];
  _vehicle_29 = _this;

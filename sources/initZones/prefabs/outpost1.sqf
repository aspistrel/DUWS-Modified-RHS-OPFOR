...
if (true) then
{
  _this = createVehicle ["rhs_Flag_Russia_F", [1802.4535, 5573.8809, 4.7683716e-007], [], 0, "CAN_COLLIDE"];
  _vehicle_40 = _this;
...
if (true) then
{
  _this = createVehicle ["hs_weapons_crate_ak_standard", [1805.345, 5571.2075, -3.0040741e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_42 = _this;
...
if (true) then
{
  _this = createVehicle ["hs_weapons_crate_ak_standard", [1808.0404, 5586.0098, 1.7642975e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_44 = _this;

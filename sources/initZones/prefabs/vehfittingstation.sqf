...
if (true) then
{
  _this = createVehicle ["RHS_Ural_MSV_01", [1802.9224, 5576.1797, 1.0490417e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_105 = _this;
...
if (true) then
{
  _this = createVehicle ["RHS_Ural_Open_MSV_01", [1802.2045, 5585.0039, 8.5830688e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_107 = _this;
...
if (true) then
{
  _this = createVehicle ["rhs_tigr_msv", [1816.5087, 5582.4043], [], 0, "CAN_COLLIDE"];
  _vehicle_184 = _this;

...
// Type of attack wave
[] spawn {
          WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_infantry" >> "rhs_group_nato_usarmy_wd_infantry_team");

          waitUntil {sleep 1;WARCOM_blufor_ap>40};          
          WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_infantry" >> "rhs_group_nato_usarmy_wd_infantry_squad"); 
          
          waitUntil {sleep 1;WARCOM_blufor_ap>65};          
          WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_infantry" >> "rhs_group_nato_usarmy_wd_infantry_weaponsquad"); 
          
          waitUntil {sleep 1;WARCOM_blufor_ap>100};          
          WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_bradleyA3" >> "rhs_group_nato_usarmy_wd_bradleyA3_squad");
          
          waitUntil {sleep 1;WARCOM_blufor_ap>135};          
          WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_bradleyA3" >> "rhs_group_nato_usarmy_wd_bradleyA3_squad_mg_sniper");
...
[] spawn {
          ...
          while {Warcom_Limiter_Param == 1} do {
			  ...
			  // find a zone *** end //////////////////////Spawn Troops
			   ...
			   if (aliveAllTanks>7) then {WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_infantry" >> "rhs_group_nato_usarmy_wd_infantry_weaponsquad")}
			  ...
			  _opf_assault = [_group] execVM "WARCOM\WARCOM_wp_blu_patrol.sqf"; 
				...
				if ((WARCOM_blufor_ap>50) && (aliveAllTanks<8)) then {
					...
					["rhs_faction_usarmy_wd","rhs_vehclass_ifv",_randomZone] execVM "WARCOM\random_veh_blu_patrol.sqf";
				...
				if ((Attack) && (WARCOM_blufor_ap>149) && (aliveAllAir< 3)) then {
					...
					["rhs_faction_usarmy_wd","rhs_vehclass_helicopter",_randomZone] execVM "WARCOM\random_veh_blu_patrol.sqf";
...
[] spawn {
          ...
          while {Warcom_Limiter_Param == 0} do {
			  ...
			  if ((count WARCOM_zones_controled_by_BLUFOR > 1) && (aliveAllUnits < WARCOMLimitAI)) then { // make sure blufor is controlling at least 2 zones
			  sleep 2;
			  ...
			  _failSafe = 0;
			   ...
			   aliveAllTanks = {(alive _x) && ((_x isKindOf "Tank") || (_x isKindOf "car"))} count vehicles;
			   if (aliveAllTanks>11) then {WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "rhs_faction_usarmy_wd" >> "rhs_group_nato_usarmy_wd_infantry" >> "rhs_group_nato_usarmy_wd_infantry_weaponsquad")}
			   else{WARCOM_blu_patrol_type = FIRSTCHOICEBLU}; ///if too many vehicles then downgrade to non-vehicle groups			   
			  _group = [_randomZone, WEST, WARCOM_blu_patrol_type,[],[],WARCOM_blu_ai_skill_range] call BIS_fnc_spawnGroup;			   
			  _opf_assault = [_group] execVM "WARCOM\WARCOM_wp_blu_patrol.sqf";

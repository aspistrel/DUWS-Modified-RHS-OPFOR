...
_HQguard3 = _groupGuard createUnit ["rhs_msv_officer", _centerPos, [], 0, "FORM"];
...
_HQguard4 = _groupGuard createUnit ["rhs_msv_at", _centerPos, [], 0, "FORM"];
...
_HQguard5 = _groupPatrol createUnit ["rhs_msv_grenadier", _centerPos, [], 0, "FORM"];

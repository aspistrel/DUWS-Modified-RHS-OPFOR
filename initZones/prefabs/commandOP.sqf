...
if (true) then
{
  _this = createVehicle ["rhs_weapons_crate_ak_standard", [1810.3711, 5580.5601, -9.5367432e-007], [], 0, "CAN_COLLIDE"];
  _vehicle_152 = _this;
...
if (true) then
{
  _this = createVehicle ["rhs_weapons_crate_ak_standard", [1809.3738, 5577.7437, -5.7220459e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_153 = _this;
...
if (true) then
{
  _this = createVehicle ["rhs_Flag_Russia_F", [1809.0244, 5586.3179, 2.9563904e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_169 = _this;

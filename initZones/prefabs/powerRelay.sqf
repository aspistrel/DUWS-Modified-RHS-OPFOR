...
if (true) then
{
  _this = createVehicle ["rhs_Flag_Russia_F", [1816.1584, 5629.0845, 1.4305115e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_68 = _this;
...
if (true) then
{
  _this = createVehicle ["RHS_Ural_MSV_01", [1810.3815, 5620.46], [], 0, "CAN_COLLIDE"];
  _vehicle_74 = _this;
